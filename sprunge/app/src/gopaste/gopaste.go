...
var (
	...
	SITE_URL = "https://domain.me"
	LISTEN_PORT = "8001"

        LANGS = []string{"markup", "html", "css", "clike", "javascript", "java",
                "php", "scss", "bash", "c", "cpp", "python", "sql", "ruby", "rust",
                "go", "haskell", "objectivec", "apacheconf", "json", "docker", "nginx",
                "perl", "dns-zone-file", "makefile", "lua", "yaml", "vim", "wiki", "makrdown"}
)
...
func handleLand(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "cat filename | curl -F 'paste=<-' https://domain.me")
}
